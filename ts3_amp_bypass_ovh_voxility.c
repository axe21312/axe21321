...
This script needs a reflection for amplification or without a reflection file just type touch file.txt, uses only one NIC compile with gcc scriptname.c -o scriptname  */
